...
public class ClienteAhorcado_1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(juego.PalabraOculta(juego.Palabra()));
            do{
                ...
                if(juego.Victoria().equals("Felicidades Ganaste")){
                    ...
                    System.out.println("Adivinaste la Palabra era == > "+juego.Palabra());
                    System.exit(0);
                }
            }while(intentos != 0 );
            ...
            Logger.getLogger(ClienteAhorcado_1.class.getName()).log(Level.SEVERE, null, ex);
